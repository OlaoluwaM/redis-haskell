...
import Redis.RDB.Data (RDBVal, toRDBVal)
...
encodeThenDecodeRDBVal :: ByteString -> RDBVal
encodeThenDecodeRDBVal = fst . runGet (execRDBGet defaultRDBConfig rdbGet) . snd . runPutM . execRDBPut . rdbPut . toRDBVal
